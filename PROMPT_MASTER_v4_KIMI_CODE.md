## 🚀 INSTRUÇÃO INICIAL (Ler antes de tudo)

> **Este é o Prompt Master v4.0 criado por Luna (NEXO DIGITAL CTO Virtual) com base em análise completa do Dashboard.**
>
> **Implemente as correções e melhorias descritas abaixo.**
>
> **Priorize:**
> 1. **Correções críticas** (caixa inconsistente, parser WhatsApp, formulários site, tarefas desatualizadas)
> 2. **Melhorias médias** (projeção financeira, alertas, integrações)
> 3. **Novas features** (pipeline leads, kanban, timeline)
>
> **Pergunte ao Abner sobre os formulários do site chatopsmaster.com se necessário.**

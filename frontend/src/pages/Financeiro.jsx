          ...
          <div>
            ...
            <div className="space-y-2">
              {payments?.slice(0, 3).map((p) => (
                <div key={p.id} className="flex items-center justify-between py-2 border-b border-nexo-border last:border-0">
                  <div className="min-w-0">
          ...
          <div>
            ...
            <div className="space-y-2">
              {expenses?.slice(0, 3).map((e) => (
                <div key={e.id} className="flex items-center justify-between py-2 border-b border-nexo-border last:border-0">
                  <div className="min-w-0">

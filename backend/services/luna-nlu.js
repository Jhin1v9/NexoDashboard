...
const DOMAINS = {
  ...
  sistema: {
    ...
    intents: [
      ...
      'sistema.monitorar',
      'sistema.processos',
      'sistema.matar_processo',
      'sistema.pm2',
      'sistema.controlar_pm2',
      'sistema.systemd_status',
      'sistema.controlar_systemd',
      'sistema.shell',
      'sistema.arquivos',
      'sistema.ler_arquivo',
      'sistema.tail',
...
const TRAINING_CORPUS = {
  ...
  // ══════════════════════════════════════════════════════════════════════════
  // DOMÍNIO: ADMINISTRAÇÃO DE SISTEMA
  // ══════════════════════════════════════════════════════════════════════════
  'sistema.monitorar': {
    pt: [
      'como está o pc', 'status do sistema', 'monitora o sistema', 'mostra métricas',
      'quanto de memória', 'quanto de ram', 'uso de cpu', 'disco cheio',
      'temperatura do sistema', 'uptime', 'quanto tempo ligado',
      'como está a máquina', 'estado do hardware', 'monitoramento',
      'mostra o health', 'health check', 'diagnóstico do sistema',
      'quanto de espaço livre', 'memória livre', 'cpu alta',
    ],
    es: [
      'cómo está la pc', 'estado del sistema', 'monitoriza el sistema', 'muestra métricas',
      'cuánta memoria', 'cuánta ram', 'uso de cpu', 'disco lleno',
      'temperatura del sistema', 'uptime', 'tiempo encendido',
    ],
    ca: [
      'com està el pc', 'estat del sistema', 'monitora el sistema', 'mostra mètriques',
      'quanta memòria', 'quanta ram', 'ús de cpu', 'disc ple',
    ],
  },
  'sistema.processos': {
    pt: [
      'lista processos', 'mostra processos', 'processos rodando', 'quem está consumindo cpu',
      'quem está consumindo memória', 'top processos', 'processos ativos',
      'o que está rodando', 'quais processos', 'ps aux',
    ],
    es: [
      'lista procesos', 'muestra procesos', 'procesos corriendo', 'quién consume cpu',
      'quién consume memoria', 'top procesos',
    ],
    ca: [
      'llista processos', 'mostra processos', 'processos en execució',
    ],
  },
  'sistema.matar_processo': {
    pt: [
      'mata processo', 'mata o processo', 'fecha processo', 'kill processo',
      'termina processo', 'mata pid', 'fecha aplicativo', 'mata programa',
    ],
    es: [
      'mata proceso', 'mata el proceso', 'cierra proceso', 'kill proceso',
      'termina proceso', 'mata pid',
    ],
    ca: [
      'mata procés', 'mata el procés', 'tanca procés', 'kill procés',
    ],
  },
  'sistema.pm2': {
    pt: [
      'lista pm2', 'mostra pm2', 'processos pm2', 'status pm2',
      'o que está no pm2', 'pm2 status', 'pm2 list',
    ],
    es: [
      'lista pm2', 'muestra pm2', 'procesos pm2', 'estado pm2',
    ],
    ca: [
      'llista pm2', 'mostra pm2', 'processos pm2',
    ],
  },
  'sistema.controlar_pm2': {
    pt: [
      'inicia pm2', 'para pm2', 'reinicia pm2', 'restart pm2',
      'start pm2', 'stop pm2', 'reload pm2', 'flush pm2',
      'inicia processo no pm2', 'para processo no pm2',
    ],
    es: [
      'inicia pm2', 'para pm2', 'reinicia pm2',
    ],
    ca: [
      'inicia pm2', 'para pm2', 'reinicia pm2',
    ],
  ...
  'sistema.systemd_status': {
    pt: [
      'status do serviço', 'estado do serviço', 'serviço rodando',
      'systemctl status', 'como está o serviço', 'serviço ativo',
    ],
    es: [
      'estado del servicio', 'servicio corriendo', 'systemctl status',
    ],
    ca: [
      'estat del servei', 'servei en execució',
    ],
  },
  'sistema.controlar_systemd': {
    pt: [
      'inicia serviço', 'para serviço', 'reinicia serviço', 'systemctl start',
      'systemctl stop', 'systemctl restart', 'liga serviço', 'desliga serviço',
      'ativa serviço', 'desativa serviço',
    ],
    es: [
      'inicia servicio', 'para servicio', 'reinicia servicio',
    ],
    ca: [
      'inicia servei', 'para servei', 'reinicia servei',
    ],
  },
  'sistema.shell': {
    pt: [
      'executa comando', 'roda comando', 'comando shell', 'bash',
      'executa no terminal', 'roda no terminal', 'executa script',
      'faz um ls', 'faz um ps', 'faz um df', 'faz um top',
      'mostra df', 'mostra du', 'mostra free', 'mostra uptime',
    ],
    es: [
      'ejecuta comando', 'corre comando', 'comando shell',
    ],
    ca: [
      'executa comando', 'comando shell',
    ],
  },
  'sistema.arquivos': {
    pt: [
      'lista arquivos', 'mostra pasta', 'lista diretório', 'ls',
      'o que tem na pasta', 'conteúdo da pasta', 'arquivos do diretório',
    ],
    es: [
      'lista archivos', 'muestra carpeta', 'lista directorio',
    ],
    ca: [
      'llista arxius', 'mostra carpeta', 'llista directori',
    ],
  },
  'sistema.ler_arquivo': {
    pt: [
      'ler arquivo', 'mostra conteúdo do arquivo', 'cat arquivo',
      'o que tem no arquivo', 'conteúdo do arquivo', 'abre arquivo',
    ],
    es: [
      'leer archivo', 'muestra contenido del archivo',
    ],
    ca: [
      'llegeix arxiu', 'mostra contingut de l\'arxiu',
    ],
  },
  'sistema.tail': {
    pt: [
      'tail do arquivo', 'últimas linhas', 'final do arquivo',
      'mostra o final do arquivo', 'tail arquivo',
    ],
    es: [
      'tail del archivo', 'últimas líneas', 'final del archivo',
    ],
    ca: [
      'tail de l\'arxiu', 'últimes línies',
    ],
  },
  'sistema.buscar': {
    pt: [
      'busca arquivo', 'encontra arquivo', 'find arquivo',
      'procura arquivo', 'onde está o arquivo', 'localiza arquivo',
    ],
    es: [
      'busca archivo', 'encuentra archivo', 'find archivo',
    ],
    ca: [
      'busca arxiu', 'troba arxiu',
    ],
  },
  'sistema.cron': {
    pt: [
      'lista cron', 'mostra cron jobs', 'crontab', 'tarefas agendadas',
      'jobs do cron', 'agendamentos', 'o que está agendado',
    ],
    es: [
      'lista cron', 'muestra cron jobs', 'crontab',
    ],
    ca: [
      'llista cron', 'mostra cron jobs',
    ],
  },
  'sistema.cron_add': {
    pt: [
      'adiciona cron', 'nova tarefa cron', 'agenda comando', 'cron job novo',
      'adiciona agendamento', 'marca no cron',
    ],
    es: [
      'añade cron', 'nueva tarea cron', 'agenda comando',
    ],
    ca: [
      'afegeix cron', 'nova tasca cron',
    ],
  },
  'sistema.cron_remove': {
    pt: [
      'remove cron', 'deleta cron job', 'tira cron', 'remove agendamento',
    ],
    es: [
      'elimina cron', 'borra cron job',
    ],
    ca: [
      'elimina cron', 'treu cron',
    ],
  },
  'sistema.logs': {
    pt: [
      'mostra logs', 'logs do sistema', 'journalctl', 'logs do serviço',
      'ver logs', 'últimos logs', 'logs recentes',
    ],
    es: [
      'muestra logs', 'logs del sistema', 'journalctl',
    ],
    ca: [
      'mostra logs', 'logs del sistema',
    ],
  },
...
async function populateCorpus() {
  ...
  const DEFAULT_ANSWERS = {
    ...
    'sistema.monitorar': {
      pt: 'Consultando métricas do sistema...',
      es: 'Consultando métricas del sistema...',
      ca: 'Consultant mètriques del sistema...',
    },
    'sistema.processos': {
      pt: 'Listando processos...',
      es: 'Listando procesos...',
      ca: 'Llistant processos...',
    },
    'sistema.matar_processo': {
      pt: 'Matando processo...',
      es: 'Matando proceso...',
    ...
    'sistema.controlar_pm2': {
      pt: 'Executando ação no PM2...',
      es: 'Ejecutando acción en PM2...',
      ca: 'Executant acció a PM2...',
    },
    'sistema.systemd_status': {
      pt: 'Verificando status do serviço...',
      es: 'Verificando estado del servicio...',
      ca: 'Verificant estat del servei...',
    },
    'sistema.controlar_systemd': {
      pt: 'Executando systemctl...',
      es: 'Ejecutando systemctl...',
      ca: 'Executant systemctl...',
    },
    'sistema.shell': {
      pt: 'Executando comando...',
      es: 'Ejecutando comando...',
      ca: 'Executant comando...',
    },
    'sistema.arquivos': {
      pt: 'Listando arquivos...',
      es: 'Listando archivos...',
      ca: 'Llistant arxius...',
    },
    'sistema.ler_arquivo': {
      pt: 'Lendo arquivo...',
    ...
    'sistema.tail': {
      pt: 'Lendo final do arquivo...',
      es: 'Leyendo final del archivo...',
      ca: 'Llegint final de l\'arxiu...',
    },
    'sistema.buscar': {
      pt: 'Buscando arquivos...',
      es: 'Buscando archivos...',
      ca: 'Buscant arxius...',
    },
    'sistema.cron': {
      pt: 'Consultando cron jobs...',
      es: 'Consultando cron jobs...',
      ca: 'Consultant cron jobs...',
    },
    'sistema.cron_add': {
      pt: 'Adicionando cron job...',
      es: 'Añadiendo cron job...',
      ca: 'Afegint cron job...',
    },
    'sistema.cron_remove': {
      pt: 'Removendo cron job...',
      es: 'Eliminando cron job...',
      ca: 'Eliminant cron job...',
    },
    'sistema.logs': {
      pt: 'Buscando logs...',
      es: 'Buscando logs...',
